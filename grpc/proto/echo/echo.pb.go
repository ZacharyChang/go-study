...
func init() {
	proto.RegisterType((*EchoRequest)(nil), "grpc.example.echo.EchoRequest")
	proto.RegisterType((*EchoResponse)(nil), "grpc.example.echo.EchoResponse")
}
...
var fileDescriptor_08134aea513e0001 = []byte{
	...
	,
}
...
func (c *echoClient) UnaryEcho(ctx context.Context, in *EchoRequest, opts ...grpc.CallOption) (*EchoResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/grpc.example.echo.Echo/UnaryEcho", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *echoClient) ServerStreamingEcho(ctx context.Context, in *EchoRequest, opts ...grpc.CallOption) (Echo_ServerStreamingEchoClient, error) {
	stream, err := c.cc.NewStream(ctx, &_Echo_serviceDesc.Streams[0], "/grpc.example.echo.Echo/ServerStreamingEcho", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *echoClient) ClientStreamingEcho(ctx context.Context, opts ...grpc.CallOption) (Echo_ClientStreamingEchoClient, error) {
	stream, err := c.cc.NewStream(ctx, &_Echo_serviceDesc.Streams[1], "/grpc.example.echo.Echo/ClientStreamingEcho", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *echoClient) BidirectionalStreamingEcho(ctx context.Context, opts ...grpc.CallOption) (Echo_BidirectionalStreamingEchoClient, error) {
	stream, err := c.cc.NewStream(ctx, &_Echo_serviceDesc.Streams[2], "/grpc.example.echo.Echo/BidirectionalStreamingEcho", opts...)
	if err != nil {
		return nil, err
	}
...
func _Echo_UnaryEcho_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/grpc.example.echo.Echo/UnaryEcho",
	}
...
var _Echo_serviceDesc = grpc.ServiceDesc{
	ServiceName: "grpc.example.echo.Echo",
